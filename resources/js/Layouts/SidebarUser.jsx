...
export default function MultiLevelSidebar({children, className = ''}) {
  ...
  window.addEventListener('resize', () => {
      setSidebarState(window.innerWidth < 577 ? 0 : window.innerWidth < 1024 ? 1 : 2)
  ...
  const openedSidebar = () => {
    return (
      <Card 
        className={"w-1/5 h-screen px-4 shadow-xl shadow-slate-950 rounded-none transition-all duration-300 fixed top-0 left-0 " + className}
      >
        ...
        <List className="min-w-full">
          ...
          <Link href={route('Dashboard')}>
            <ListItem className="w-full">
              <ListItemPrefix>
                <PresentationChartBarIcon className="h-5 w-5" onClick={() => setSidebarState(1)}/>
              </ListItemPrefix>
                Dashboard
            </ListItem>
          </Link>
  ...
  const minimizedSidebar = () => {
    return (
      <Card 
        className={"w-[60px] h-screen shadow-xl shadow-slate-950 rounded-none transition-all duration-300 fixed top-0 left-0 " + className}
      >
        <div className="px-3">
  ...
  const mobileSidebar = () => {
    return (
      <IconButton color="white">
        <Bars3BottomLeftIcon className="w-5 h-5" onClick={() => setSidebarState(1)}/>
      </IconButton>
    )
  }
  ...
  return (
    <>
      ...
      <div className="box-border flex flex-row min-h-screen gap-x-7 bg-blue-gray-50 overflow-x-hidden">
          ...
          <div className={ 
                  (sidebarState === 1 ? desktopMinimizedStyle : 
                  sidebarState === 2 && isMobile ? mobileOpenedStyle :
                  sidebarState === 2 ? desktopFullStyle : 'w-screen p-5') + ' transition-all duration-300'
              }>
