...
export default function AddMahasiswa({ auth }) {
        ...
        <>
            ...
            <div className="grid grid-cols-7 gap-1">
                ...
                <div className="mt-10 w-full h-72 col-span-4">
                    <div className='title'>
                        <div className='judul'>
                            <AddTitle type="Mahasiswa" matkul="Pemrograman Berorientasi Objek" 
                        ...
                        <div className='table-ajax'>
                            <Typography variant="h5" color="blue-gray" className='mt-10 mb-4'>Detail Mahasiswa</Typography>
                            <TableNoButton TABLE_HEAD={head_mhs_ajax} TABLE_ROWS={data_mhs_ajax}/>
                            <br />
                        </div>
    
                        <div className='list-add mt-10'>
                            <LabelAddMhsTable total="10"/>
                            <TableWithDeleteButton TABLE_HEAD={head_mhs} TABLE_ROWS={data_mhs}/>
                        </div>
