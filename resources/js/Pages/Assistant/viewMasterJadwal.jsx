            ...
            <SidebarUser routes={routes}>
                <div className="mt-10 md:mt-0">
                    ...
                    <form
                        ...
                        className="mx-auto md:w-2/3 lg:w-1/2 xl:w-1/2"
                    >
                        <div className="mb-6 grid grid-cols-1 md:grid-cols-2 md:gap-6">
                    ...
                    >
                        <Card className="mx-auto w-full">
                            ...
                            <CardFooter className="pt-0">
                                <div className="flex gap-4">
                                    <Button variant="gradient" color="red" onClick={() => setOpen(false)} className="w-full">
                                        Cancel
                                    </Button>
                                    <Button
                                        variant="gradient"
