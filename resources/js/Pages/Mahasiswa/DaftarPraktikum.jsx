            ...
            <SidebarUser routes={routes}>
                <div className="mt-10 md:mt-0">
                    ...
                    {/* <div className="mt-2 w-full h-72 bg-slade lg:mx-44 md:mx-8 sm:mx-4"> */}
                        {!ValidateStatus &&(
                        <div className="col-span-1 flex-auto">
                        <form onSubmit={handleSubmit} method="POST">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8 mb-3 md:mb-8 w-full">
                        ...
                        <Button
                            variant="gradient"
                            color="indigo"
                            className="btn w-full md:w-auto mb-6 md:mb-8"
                            type="submit"
                        >
                            Input
                        </Button>
                        ...
                        <div
                            className="col-span-1 flex-auto w-full mb-5"
                        >
                            <DataTable rawData={data} columns={columnssss}>
                                <DataTableContext.Consumer>
                                    {(context) => (
                                        <Card className="w-full z-[1] border mb-5">
                                            <TableHeader
                                                title={Event}
